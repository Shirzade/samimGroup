        ...
        <b-container-floid data-aos="fade-up" data-aos-duration="2000">
            <b-row class="internal-wrapper">
                ...
                <b-col cols="12" lg="8" md="8" offset-md="1" offset-lg="1">
                    <!-- <app-breadcrumb :breadcbItems=breadcrumbItemsSingleBlogPage></app-breadcrumb> -->
                    <!-- Title of Post -->
                    <app-title :title=getBlogPostTitle classStyle="single-blog-title"></app-title>
                    <app-title :title=getBlogPostSubTitle classStyle="single-blog-sub-title"></app-title>
    ...
    export default {
        ...
        head: {
            meta: [
                ...
                {property: 'og:url', content: "https://www.samimgroup.com/bit-caster"}
            ],
            link: [
                {rel: 'canonical', href: 'https://www.samimgroup.com/singleBlog'}
            ],
        },
        computed: {
            ...mapGetters([
        ...
        created() {
            ...
            this.setBlogPostContent(this.$route.params.id)
        },
