        ...
        <b-container-flouid id="single-product">
            ...
            <b-row align-h="center">
                <b-col cols="9">
                    <b-row>
                        <b-col cols="12" lg="12">
                            <app-breadcrumb-page :items="getBreadcrumbItemsProductSinglePage"></app-breadcrumb-page>
                            <!-- <app-breadcrumb :breadcbItems=getBreadcrumbItemsProductSinglePage></app-breadcrumb> -->
                        </b-col>
                    </b-row>
                    <b-row>
                    ...
                    <b-row>
                        <app-slider-product-image
                                :altImage=getProductName
                                firstImage="1.png"
                                secondImage="2.png"
                                thirdImage="3.png"></app-slider-product-image>
                        <b-col cols="12" lg="5" class="right-section">

                            <app-page-main-title v-if="getProductCleanUrl" :title=getProductCleanUrl
                                                 classStyle="product-page-main-title"></app-page-main-title>
                            <app-page-sub-title :title=getProductDescription
                                                 classStyle="product-page-sub-title-product"></app-page-sub-title>
                            <app-page-sub-title :title=getProductName
                                                classStyle="product-page-sub-sub-title"></app-page-sub-title>
    ...
    export default {
        ...
        head: {
            meta() {
                return [
                    ...
                    {property: 'og:url', content: "https://www.samimgroup.com/product/" + this.$route.params.pid+"/"+this.$route.params.title}
                ]
            },
            link() {
                return [
                    {rel: 'canonical', href: 'https://www.samimgroup.com/product/' + this.$route.params.pid+"/"+this.$route.params.title}
                ]
            }
        },
        components: {
        ...
        computed: {
            ...mapGetters([
                ...
                'getBreadcrumbItemsProductSinglePage',
                'getShowLoading'
            ]),
        },
        methods: {
