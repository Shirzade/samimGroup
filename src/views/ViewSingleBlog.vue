    ...
    <div id="single-blog">
        ...
        <b-container-floid data-aos="fade-up" data-aos-duration="2000">
            <b-row class="internal-wrapper">
                <app-breadcrumb :breadcbItems=getBreadcrumbItemsBlogPostPage></app-breadcrumb>
                    ...
                    <div v-if=!getShowLoading>
                        <div class="content-of-post">
                            <div class="container-tip-image">
                                <picture-sharesheet
                                        :src=linkProductImage+getBlogPostId+linkProductImageSecondSection
                                        :key=this.getBlogPostId
                                        :alt=this.getBlogPostTitle
...
<script>
    ...
    export default {
        ...
        head: {
            meta() {
                return [
                    ...
                    {property: 'og:url', content: "https://www.samimgroup.com/blog/post/" + this.cleanUrl(this.$route.params.id)}
                ]
            },
            link() {
                return [
                    {rel: 'canonical', href: 'https://www.samimgroup.com/blog/post/' + this.cleanUrl(this.$route.params.id)}
                ]
            }
        },
        computed: {
            ...mapGetters([
                ...
                'getPostMetaTitle',
                'getBreadcrumbItemsBlogPostPage',
                'getBlogPostSubTitle']),
        },
        methods: {
            ...mapActions([
        ...
        created() {
            ...
            title = this.$route.params.id.replace(/-/g, ' ')
            this.setBlogPostContent(title)
        },
    }
</script>
